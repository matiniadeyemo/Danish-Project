...
>
  ...
  >
    ...
    <p>Gifts dispatched from countries outside the EU</p>
  </router-link>
   </div>
    ...
    <section class="lg:p-7 p-0 mt-6 sm:px-7 flex  gap-[2rem] lg:gap-0 flex-col lg:flex-row justify-between md:gap-[3rem]">
        <div class="bg-white shadow-sm border flex flex-col gap-2  min-h-[25rem lg:w-[58rem] lg:min-h-[51rem]" >
          ...
          <div class="border-t border">
                ...
                <div class="px-5 flex flex-col justify-between gap-3  lg:w-[90%]">
                     <h1 class="lg:text-5xl text-3xl lg:font-extrabold font-bold text-midnidnight mt-[1rem]">Gifts dispatched from countries outside the EU</h1>
                     <p class="lg:text-[1.4rem] text-[1.3rem] line text-base">If you receive a gift from a private individual in a country outside the EU, you must pay customs duty and VAT if the gift has a value of more than DKK 360. If the gift contains spirits, wine, perfume or tobacco products, special rules apply.</p>
                </div>
                    <div class="lg:p-7 p-3 flex flex-col justify-between gap-4 mb-2">
                    <p class="lg:text-[1.2rem] text-base">If the gift has a value of more than DKK 360, you must pay customs duty and 25% VAT on the value of the item, including shipping costs. The customs duty rate varies, depending on the type of goods. The carrier will calculate and declare customs duty and VAT on your gift and may charge a fee for this.  </p>
                </div>
                </article>
                <div class="">
...
>
                    ...
                    <ul class="list-disc p-7">
                        <li>the consignment is dispatched occasionally; </li>
                        <li>the parcel only contains goods intended for the recipient’s or the recipient’s family's personal use; </li>
                        <li>the parcel is dispatched to the recipient without any form of payment.</li>
                    </ul>
                    </div>
                </div>
                </div>
                <div class="group relative border-t border-midnight transition-all duration-500 ease-in-out"
                    ...
                    <span>Value and contents of the gift</span>
                    
                    </button>
                    <div id="content-2" v-if="Accord === 2" class="p-7 text-base flex flex-col gap-[1rem]  text-[#0A0A3D]/80 overflow-hidden transition-all duration-500 ease-in-out"
>
                    <p>The carrier’s calculation of how much you need to pay in customs duty for your gift is based on the value of the goods. The value is the actual price paid for the goods in the country of purchase, including any taxes and duties. If no invoice is attached, it may be necessary to assess the specific value of the gift. </p>
                    <p>Shipping costs should not be included in the assessment of whether the value of the gift is below the VAT and customs duty threshold.</p>
                   <strong class="text-xl font-extrabold text-midnight">Consignments containing several gifts </strong>
                  <p>If the consignment contains several items, you do not have to pay customs duty on the item(s) with a total value of less than DKK 360. If the total value of several items exceeds DKK 360 per consignment, the items are only duty-free up to this threshold in total.</p>
                   <div class=" border-l border-midnight border-l-[6px]  flex flex-col gap-[1rem] lg:w-[45rem] h-[20rem] lg:h-[20rem] bg-[#e8e2e1] p-4 text-xl text-midnight">
                    <h1 class="text-2xl font-bold">Example</h1>
                    <p class="text-[1rem]">If the consignment contains two items valued at DKK 420 and DKK 120, respectively, you can only receive the item with the lowest value without paying customs duty.</p>
                    <p class="text-[1rem]">The value of the individual item must not be divided up. For consignments containing several items, the value of each individual item must also be clearly stated. Otherwise, you will have to pay customs duty on the value of the whole consignment. </p>
                    <p class="text-[1rem]">You must always pay VAT if the total value of the consignment exceeds DKK 360 – regardless of whether the consignment contains items that do not exceed the threshold. </p>
                  </div>
            </div>
                </div>
                <div class="group relative border-t border-midnight transition-all duration-500 ease-in-out"
                    ...
                    <svg
                        id="arrow-3"
                        class="l:w-5 lg:h-5 w-10 h-10 transform transition-transform duration-300"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    ...
                    <span>Gifts containing spirits, wine, perfume or tobacco products</span>
...
>
                    <p>If your gift contains spirits, wine, perfume or tobacco products, other rules apply. You will always have to pay VAT and possibly special duties on these items even if it is a gift.  </p>    
                    <p>However, you do not have to pay customs duty for the following quantity per consignment: </p>
                    <table class="text-midnight text-lg border-collapse border  w-full p-8">
                    <tbody class="group hover:bg-gray-200">
                        <tr>
                        <td class="border pl-[3rem] pt-[2rem] border-gray-200 group-hover:border-gray-200 text-base" >
                            <strong>Strong alcoholic beverages</strong>
                            <p>You may receive one of the following quantities or a combination thereof:</p>
                            <ul class="py-[4rem] px-[4rem] list-disc">
                              <li>Spirits above 22%, 1 litre </li>
                              <li>Fortified wine not above 22%, 1 litre  </li>
                              
                            </ul>

                        </td>
                        
                        <td class="border p-2 border-gray-200 text-base pl-[3rem] py-[2rem] group-hover:border-gray-200">
                            <strong>Tobacco products </strong>
                            <p>You may receive one of the following quantities or a combination thereof:  </p>
                            <ul class="list-disc py-[4rem] px-[4rem]">
                                <li>Cigarettes, 50 pcs </li>
                                <li>Cigarillos, 25 pcs  </li>
                                <li>Cigars, 10 pcs  </li>
                                <li>Smoking tobacco, 50 g </li>
                            </ul>
                        </td>
                        </tr>
                    </tbody>
                    <tbody class="group hover:bg-gray-200">
                        <tr> 
                            <td class="flex flex-col border pl-[3rem] py-[2rem] gap-[1rem] border-gray-200 py-[1rem] text-base">
                            <strong>Other alcoholic beverages</strong>
                            <p>You may receive one of the following quantities:  </p>
                            <ul class=" list-disc px-[1rem] py-[3rem]">
                              <li>Table wine, 2 litres  </li>
                            </ul>
                        </td>
                         <td class="border p-2 border-gray-200 pl-[3rem] text-base">
                          <div class="flex flex-col gap-[1rem]">
                            <strong>Perfumery </strong>
                            <p>You may receive one of the following quantities:</p>
                          </div>
                             <ul class=" list-disc px-[1rem] py-[3rem]">
                              <li>Perfume, 50 g </li>
                              <li>Eau de toilette, ¼ litre</li>
                            </ul>
                        </td>
                        </tr>
                    </tbody>
                    </table>
                    <p class="p-5">The quantities can be combined within the categories, and you may consequently receive a consignment containing, for example, both 10 cigars and 50 cigarettes, without having to pay customs duties.  </p>
                </div>
                </div>

                <div class="group relative border-t border-midnight transition-all duration-500 ease-in-out pb-5"
                    ...
                    <span>The carrier charges VAT and customs duties - and a fee</span>
...
>
                    <p>The carrier will often be responsible for calculating customs duties and VAT and may charge a fee for calculating these amounts and for customs declaration of the consignment. The Danish Customs Agency has no influence on this fee or the amount you will pay. </p>    
                </div>
                </div>
                <hr  class="border-t border-midnight p-4">
                </div>
            </div>
        </div>
        <div class="bg-white shadow-sm border flex flex-col gap-2 w-full lg:w-[21rem] h-[23rem] relative">
            ...
            <div class="flex flex-row items-center">
              <div class="absolute lg:top-[11rem] top[2rem]  left-0 right-0 h-10 w-2 bg-midnight "></div>
              <h1 class="text-lg text-midnidnight lg:mt-[0.5rem]">Gifts dispatched from countries outside the EU</h1>
              </div>
