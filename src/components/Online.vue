...
>   
        ...
        <section class="lg:p-7 p-0 mt-6 sm:px-7 flex flex-col  gap-[2rem]  justify-between md:gap-[3rem]">
        <div class="bg-white shadow-sm border flex flex-col gap-2 h-[10rem] w-full">
            ...
            <div class="border-t border-gray-200 divide-y sm:divide-y-0 sm:divide-x">
                <article class="relative p-3 pl-5 flex flex-col gap-4">
                <div class="absolute top-0 left-5 h-2 w-10 bg-midnight "></div>
                    <h1 class="text-4xl font-extrabold text-midnidnight mt-[1rem]">Online shopping</h1>
                </article>
            </div>
        </div>
    </section>
      <section class=" lg:p-7 p-0 lg:mt-0 mt-4">
    <div
      class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3"
    >

      <div
        class="bg-white border-b border-r group hover:border hover:opacity-[0.8] hover:border-midnight lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.4rem] lg:font-extrabold font-bold text-midnight  leading-snug"
        >
          Online shopping within the EU
        </h3>
        <p
          class="text-midnight text-[1.05rem] leading-relaxed tracking-[0.01em] flex items-start gap-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-5 h-5 mt-[0.25rem] flex-shrink-0 text-midnight font-bold align-middle stroke-[2.5] transition-transform duration-200 group-hover:translate-x-1"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
         ...
         here are only a few rules governing online shopping within the EU, but they are important to know.
        </p>
      </div>

      <div
        class="bg-white border-b border-r border-grey-400 hover:border-midnight hover:opacity-[0.8] group hover:border lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.4rem]  lg:font-extrabold font-bold text-midnight  leading-snug"
        >
        ...
        <svg
          ...
          When buying goods online from a non-EU country, you must pay VAT, carrier’s fee and, if applicable, customs duties on the goods. 
        </p>
      </div>


      <div
        class="bg-white border-b border-grey-400 hover:border-midnight group hover:border hover:opacity-[0.8]  lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.4rem] lg:font-extrabold font-bold text-midnight leading-snug"
        >
          Online shopping and special duties
        </h3>
       <p
          class="text-midnight text-[1.05rem] leading-relaxed tracking-[0.01em] flex items-start gap-2"
        >
        <svg
          ...
          For some goods sent from another EU country, you must pay special duties. 
        </p>
      </div>
      <div class="bg-white border-b border-grey-600 hover:border-midnight group hover:border hover:opacity-[0.8] lg:p-7 p-3 flex flex-col gap-[1rem] text-left">
        <h3
          class="lg:text-2xl text-[1.4rem]  lg:font-extrabold font-bold text-midnight  leading-snug"
        >
         Customs control
        ...
        <svg
          ...
          Your postal consignment may be selected for a check. Find out more about this here.
        </p>
      </div>
    </div>
  </section>
...
const aboutItems = [
  ...
  { title: "How we are organised", link: "Organisational structure" },
  { title: "How to reach us", link: "Get in touch" },
  { title: "Where to find us", link: "Opening hours and offices" },
];
</script>
