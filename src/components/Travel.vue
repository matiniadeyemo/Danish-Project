...
>   
        ...
        <div class="bg-white shadow-sm border flex flex-col gap-2 h-[10rem] w-full">
            ...
            <div class="border-t border-gray-200 divide-y sm:divide-y-0 sm:divide-x">
                ...
                <div class="absolute top-0 left-5 h-2 w-10 bg-midnight "></div>
                    <h1 class="text-4xl font-extrabold text-midnidnight mt-[1rem]">Travel</h1>
                </article>
            </div>
        </div>
    </section>
    ...
    >
      ...
      <div
        class="bg-white border-b border-r group hover:opacity-[0.8] hover:border hover:border-midnight lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.3rem] lg:font-extrabold font-bold text-midnight  leading-snug"
        >
        ...
        >
          ...
          See the rules for bringing shopping goods, alcohol and tobacco into
          Denmark from another EU country.
        </p>
      </div>

      <div
        class="bg-white border-b border-r border-grey-400 hover:opacity-[0.8] hover:border-midnight group hover:border lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.3rem] lg:font-extrabold font-bold text-midnight  leading-snug"
        >
        ...
        <svg
          ...
          See the rules for bringing shopping goods, alcohol and tobacco into
          Denmark from a non-EU country.
        </p>
      </div>


      <div
        class="bg-white border-b border-grey-400 hover:border-midnight hover:opacity-[0.8] group hover:border  lg:p-7 p-3 flex flex-col gap-[1rem] text-left"
      >
        <h3
          class="lg:text-2xl text-[1.3rem] lg:font-extrabold font-bold text-midnight leading-snug"
        >
       ...
       <p
        ...
        <svg
          ...
          Remember that valuables amounting to EUR 10,000 or more must be
          declared to the Danish Customs Agency.
        </p>
      </div>
      <div class="bg-white border-b border-grey-600 hover:opacity-[0.8] hover:border-midnight group hover:border lg:p-7 p-3 flex flex-col gap-[1rem] text-left">
        <h3
          class="lg:text-xl text-[1.3rem] lg:font-extrabold font-bold text-midnight  leading-snug"
        >
        ...
        <svg
          ...
          Some items may require a permit for or are prohibited from being
          brought into Denmark.
        </p>
      </div>
    </div>
  </section>
